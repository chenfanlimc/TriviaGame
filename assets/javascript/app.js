...
var questionThree = {
    question: "In the Japanese mythology of Susanoo and Orochi, what is the name of the sword that slays the legednary serpent?",
...
$(document).ready(function() {
    ...
    $(".start").on("click", function() {
        ...
        $(".questionContainer").html(questionOne.question)
        for (var i = 0; i < questionOne.answersArray.length; i++) {
            var button = $('<input type="button" class= "answerButtons" value="' + questionOne.answersArray[i] + '"/>')
            $(".contentSection").append(button);
        }
        gameNavigation.actionClick(questionOne);
